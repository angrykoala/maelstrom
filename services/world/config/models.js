module.exports = {
	...
	userShips: "id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, user_id INT UNSIGNED NOT NULL, name VARCHAR(64) NOT NULL, model INT UNSIGNED NOT NULL REFERENCES ship_models(id), life INT UNSIGNED NOT NULL,status VARCHAR(64) NOT NULL, FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE, CONSTRAINT UNIQUE(user_id,name)",
